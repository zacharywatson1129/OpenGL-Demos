/*
    g++ textureDemo1.cpp glad.c -lglfw3 -ldl -lm -lGL -lGLU -lX11 -pthread -o textureDemo1
*/
#include <glad/glad.h>
...
int main()
{
	...
	printf("Just generated a texture.\n");
	...
	printf("Attempting to free up memory using stbi_image_free(data)...\n");
    stbi_image_free(data);
    printf("Memory successfully freed up.\n");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        printf("End of possible problematic area.\n");
